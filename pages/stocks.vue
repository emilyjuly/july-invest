...
onMounted(async () => {
    if (store.quoteListStock.length === 0) {
        await store.getQuoteList()
    }
    filteredData.value = [...store.quoteListStock]
...
const handleSearch = (value) => {
    filteredData.value = store.quoteListStock.filter(item => item.stock.toLowerCase().includes(value))
}
    ...
    <div class="container">
        ...
        <div class="container-page">
            <div class="container-table">
                <Table @search="handleSearch" :data="filteredData" :use-pagination="true" :show-search-input="true" :is-unstyled="false" :is-from-bdrs="true" class="w-full" />
            </div>
